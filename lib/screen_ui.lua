-- lib/screen_ui.lua v0.504
local ScreenUI = {}
ScreenUI.ping_flash = {[3] = 0}

local MenuDef = {
    [1] = { A = { title = "1023 - OSC 1", e2 = {id="m1_tune1", name="TUNE"}, e3 = {id="m1_morph1", name="MORPH"}, e1 = {id="m1_pwm1", name="PWM"}, e4 = {id="m1_fine1", name="FINE"}, k2 = {id="m1_range1", name=""}, k3 = {id="m1_out3_wave", name="WAVE"} }, B = { title = "1023 - OSC 2", e2 = {id="m1_tune2", name="TUNE"}, e3 = {id="m1_morph2", name="MORPH"}, e1 = {id="m1_pwm2", name="PWM"}, e4 = {id="m1_fine2", name="FINE"}, k2 = {id="m1_range2", name=""}, k3 = {id="m1_out4_wave", name="WAVE"} } },
    [2] = { A = { title = "STOCHASTIC NOISE", e2 = {id="m2_tilt1", name="TILT 1"}, e3 = {id="m2_tilt2", name="TILT 2"}, e1 = {id="m2_slow_rate", name="SLOW RT"}, k2 = {id="m2_type1", name="N1"}, k3 = {id="m2_type2", name="N2"} }, B = { title = "STOCHASTIC SLEW", e2 = {id="m2_rise", name="RISE"}, e3 = {id="m2_fall", name="FALL"}, e1 = {id="m2_slew_shape", name="SHAPE"}, k2 = {id="m2_cycle_mode", name="CYCLE"} }, C = { title = "STOCHASTIC S&H", e2 = {id="m2_clk_rate", name="CLOCK"}, e3 = {id="m2_prob_skew", name="SKEW"}, e1 = {id="m2_glide", name="GLIDE"}, e4 = {id="m2_clk_thresh", name="THRESH"} } },
    [3] = { A = { title = "SERGE VCFQ CORE", e2 = {id="m3_cutoff", name="FREQ"}, e3 = {id="m3_q", name="RES"}, e1 = {id="m3_agc_drive", name="AGC DRV"}, e4 = {id="m3_fine", name="FINE"}, k2 = {id="m3_ping", name="PING"} }, B = { title = "SERGE VCFQ MODS", e2 = {id="m3_fm_amt", name="FM AMT"}, e3 = {id="m3_notch_bal", name="NOTCH"}, e1 = {id="m3_ping_dcy", name="PING DCY"}, e4 = {id="m3_voct_amt", name="V/OCT"} } },
    [4] = { A = { title = "1005 RING MOD", e2 = {id="m4_mod_gain", name="MOD"}, e3 = {id="m4_unmod_gain", name="UNMOD"}, e1 = {id="m4_rm_am_mix", name="RM/AM"}, e4 = {id="m4_xfade", name="XFADE"}, k2 = {id="m4_state", name="ST"} }, B = { title = "1005 VCA", e2 = {id="m4_vca_base", name="BASE"}, e3 = {id="m4_vca_resp", name="RESP"}, e1 = {id="m4_gate_thresh", name="THRESH"}, k2 = {id="m4_state", name="ST"} } },
    [5] = { A = { title = "CYBER VCA 1", e2 = {id="m5_init_gain", name="BIAS"}, e3 = {id="m5_env_slew", name="ENV DCY"}, e1 = {id="m5_cv_amt", name="CV AMT"}, e4 = {id="m5_env_gain", name="ENV GAIN"}, k2 = {id="m5_vca_curve", name="CRV"}, k3 = {id="m5_env_src_sel", name="SRC"} } },
    [6] = { A = { title = "CYBER VCA 2", e2 = {id="m6_init_gain", name="BIAS"}, e3 = {id="m6_env_slew", name="ENV DCY"}, e1 = {id="m6_cv_amt", name="CV AMT"}, e4 = {id="m6_env_gain", name="ENV GAIN"}, k2 = {id="m6_vca_curve", name="CRV"}, k3 = {id="m6_env_src_sel", name="SRC"} } },
    [7] = { A = { title = "CYBER VCA 3", e2 = {id="m7_init_gain", name="BIAS"}, e3 = {id="m7_env_slew", name="ENV DCY"}, e1 = {id="m7_cv_amt", name="CV AMT"}, e4 = {id="m7_env_gain", name="ENV GAIN"}, k2 = {id="m7_vca_curve", name="CRV"}, k3 = {id="m7_env_src_sel", name="SRC"} } },
    [8] = { A = { title = "CYBER VCA 4", e2 = {id="m8_init_gain", name="BIAS"}, e3 = {id="m8_env_slew", name="ENV DCY"}, e1 = {id="m8_cv_amt", name="CV AMT"}, e4 = {id="m8_env_gain", name="ENV GAIN"}, k2 = {id="m8_vca_curve", name="CRV"}, k3 = {id="m8_env_src_sel", name="SRC"} } },
    [9] = { A = { title = "CYBER VCA 5", e2 = {id="m9_init_gain", name="BIAS"}, e3 = {id="m9_env_slew", name="ENV DCY"}, e1 = {id="m9_cv_amt", name="CV AMT"}, e4 = {id="m9_env_gain", name="ENV GAIN"}, k2 = {id="m9_vca_curve", name="CRV"}, k3 = {id="m9_env_src_sel", name="SRC"} } },[10] = { A = { title = "NEXUS MASTER", e2 = {id="m10_cut_l", name="VCF L"}, e3 = {id="m10_cut_r", name="VCF R"}, e1 = {id="m10_res", name="RES"}, k2 = {id="m10_filt_byp", name="FILT"}, k3 = {id="m10_adc_mon", name="ADC"} }, B = { title = "NEXUS TAPE", e2 = {id="m10_tape_time", name="TIME"}, e3 = {id="m10_tape_fb", name="FDBK"}, e1 = {id="m10_tape_mix", name="MIX"}, e4 = {id="m10_wow", name="W&F"}, k2 = {id="m10_tape_sat", name="SAT"}, k3 = {id="m10_tape_mute", name="MUTE"} } }
}
...
function ScreenUI.draw_module_menu(G)
    ...
    draw_param(def.e1, 2, 60, "E1", false); draw_param(def.e2, 2, 30, "E2", false)
    draw_param(def.e3, 2, 45, "E3", false); draw_param(def.e4, 126, 30, "E4", true)
...
function ScreenUI.enc(G, n, d)
    ...
    elseif G.focus.state == "in" or G.focus.state == "out" then
        ...
        elseif n == 2 then
            if node.module == 10 and node.type == "in" and (node.id == 57 or node.id == 58) then register_touch(G, "node_pan_" .. node.id); node.pan = util.clamp((node.pan or 0) + (d * 0.01), -1.0, 1.0); if Matrix.update_node_params then Matrix.update_node_params(node) end end
        end
    ...
    if z == 1 then
        if G.focus.state == "in" or G.focus.state == "out" then
            ...
            if node and n == 2 then
                ...
                elseif node.id == 9 then p_id = "m2_cv1_dest" elseif node.id == 10 then p_id = "m2_cv2_dest" end
