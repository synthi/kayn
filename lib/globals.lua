...
G.fine_link = {
    ["m1_tune1"] = "m1_fine1", ["m1_tune2"] = "m1_fine2",["m3_cutoff"] = "m3_fine"
}
...
-- MAPA DE MÓDULOS POR COLUMNA (Zebra Dinámico)
...
function G.init_nodes()
    ...
    -- MODS 5-9: CYBER VCAs (Cols 10-14)
    for i=0, 4 do
